...
// configuration step. It creates a namespace called `game-challenge`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        game-challenge::cmake::project_name,
        game-challenge::cmake::project_version));// version string, acquired
